...
def main(args):
    ...
    from Original_ProteinMPNN.protein_mpnn_utils import loss_nll, loss_smoothed, gather_edges, gather_nodes, gather_nodes_t, cat_neighbors_nodes, _scores, _S_to_seq, tied_featurize, parse_PDB, parse_fasta
    from Original_ProteinMPNN.protein_mpnn_utils import StructureDataset, StructureDatasetPDB, ProteinMPNN
    ...
    checkpoint = torch.load("/home/neelm/data/ProteinMPNN-copy/training/exp_020/model_weights/epoch_last.pt", weights_only=False) 
